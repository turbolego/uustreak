...
**Timestamp:** 2026-05-14T01:17:38.793Z
...
- `a[aria-label="Utvær Half Zip fleecegenser"] > .ih.bc.bd > .io.im.y > .gz.it.ip`
- `a[aria-label="Utvær Half Zip fleecegenser"] > .c0.c1.hz > div > .h3 > .jd.i0.bd`
- `a[aria-label="Drømmesky fleecesett barn 1-7"] > .ih.bc.bd > .io.im.y > .gz.it.ip`
...
- `a[aria-label="Varde speiderkniv"] > .ih.bc.bd > .io.im.y > .gz.it.ip`
...
- `.hs > .hx.hw.au`
- `.a6[href$="helgekupp"][data-scope-link="true"] > .jk.ht.hu > .hx.a2.hw`
...
- `a[href$="maisalg"]`
- `.a6[href$="helgekupp"][data-scope-link="true"]`
