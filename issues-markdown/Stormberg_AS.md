...
**Timestamp:** 2026-05-07T20:22:48.774Z
...
- `a[aria-label="Vesterfjell tursekk 60 L"] > .ih.bc.bd > .io.im.y > .gz.ip.iq`
- `a[aria-label="Vesterfjell tursekk 60 L"] > .c0.c1.hz > div > .h3 > .jd.i0.bd`
...
- `li:nth-child(2) > .ic.id[aria-label="Lofotregn skallponcho"] > .ih.bc.bd > .io.im.y > .gz.ip.iq`
- `li:nth-child(2) > .ic.id[aria-label="Lofotregn skallponcho"] > .c0.c1.hz > div > .h3 > .jd.i0.bd`
...
- `a[aria-label="Røstvær skalljakke"] > .ih.bc.bd > .io.im.y > .gz.ip.iq`
- `a[aria-label="Regnstua parkdress barn 1-7"] > .ih.bc.bd > .io.im.y > .gz.ip.iq`
