...
**Timestamp:** 2026-04-24T10:21:23.797Z
...
- `a[aria-label="Loten sneaker barn"] > .ih.bc.bd > .io.im.y > .gz.ip.iq`
...
- `li:nth-child(3) > .ic.id[aria-label="Lindum sneaker"] > .ih.bc.bd > .io.im.y > .gz.ip.iq`
- `li:nth-child(3) > .ic.id[aria-label="Lindum sneaker"] > .c0.c1.hz > div > .h3 > .jd.i0.bd`
