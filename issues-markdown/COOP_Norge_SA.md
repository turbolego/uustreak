...
- `.hi > .bt.bu.bx > .ch[placeholder="F.eks 0101 eller Oslo"][role="combobox"]`
- `div:nth-child(1) > .he.hg.hf > .hh > .bt.bu.bx > .ch[placeholder="F.eks 0101 eller Oslo"][role="combobox"]`
...
- `.kn.ko.kp:nth-child(1)`
- `.kn.ko.kp:nth-child(2)`
