...
**Timestamp:** 2026-01-31T00:37:45.507Z
...
- `.aspect-square.h-full:nth-child(1) > .group.cursor-pointer[title=""] > .md\:rounded-bl-lg.bg-cover.bg-center > img[height="348"][width="348"][loading="lazy"]`
...
- `.aspect-square.h-full:nth-child(7) > .group.cursor-pointer[title=""] > .md\:rounded-bl-lg.bg-cover.bg-center > img[height="348"][width="348"][loading="lazy"]`
- `img[alt="Spahoteller"]`
