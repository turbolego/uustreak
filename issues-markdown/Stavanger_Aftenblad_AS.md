...
**Timestamp:** 2025-12-17T00:59:27.643Z
...
- `#announcement-banner`
- `.top-60-40-block`
- `article[data-pulse-entity-id="9pmJ8W"]`
- `article[data-pulse-entity-id="n1gE25"] > .article__teaser-container`
- `article[data-pulse-entity-id="zOLpBK"] > .article__teaser-container`
- `a[data-pulse-entity-id="helgomeny-lukekalender-2025"]`
- `#skattelisten, .text`
- `#skattelisten, ol`
- `#skattelisten, #b4-tax-municipality-search`
- `#dr-edition-teaser-1mtmi2ic8 > div`
...
- `.row--full.horizontal-x1.row:nth-child(73)`
