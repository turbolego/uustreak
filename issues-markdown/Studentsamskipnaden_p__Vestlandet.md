...
**Timestamp:** 2026-02-25T00:36:29.087Z
...
- `a[href$="barnehageplass"] > .px-3.pb-3.pt-1 > .py-2.text-gray-700`
...
- `#carousel2`
- `#carousel3`
- `#carousel4 > .max-w-\[calc\(80vw\)\].md\:max-w-\[calc\(25\.4vw\)\].rounded-lg > .rounded-t-lg[target="_self"] > .relative.h-fit > .h-56.object-cover`
