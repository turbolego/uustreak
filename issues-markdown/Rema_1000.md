...
**Timestamp:** 2026-01-16T00:38:54.364Z
...
- `.b-papirfly__item.col-lg-3.col-6:nth-child(1) > a[data-toggle="modal"][role="button"][href="#"] > .f-product-card__details > .f-product-card__bottom > .f-product-card-title.text-uppercase.u-text-overflow-ellipsis`
...
- `.col-lg-4.b-banners__items__item.col-12:nth-child(14) > .embla__slide__inner > .f-banner--card.f-banner.f-banner--with-image > .f-banner__image-wrap`
