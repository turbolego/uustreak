...
**Timestamp:** 2025-11-22T00:30:50.269Z
...
- `.b-papirfly__item.col-lg-3.col-6:nth-child(9) > .f-product-card[aria-role="button"][data-toggle="modal"]`
- `.b-papirfly__item.col-lg-3.col-6:nth-child(10) > .f-product-card[aria-role="button"][data-toggle="modal"]`
- `.b-papirfly__item.col-lg-3.col-6:nth-child(11) > .f-product-card[aria-role="button"][data-toggle="modal"]`
- `.b-papirfly__item.col-lg-3.col-6:nth-child(12) > .f-product-card[aria-role="button"][data-toggle="modal"]`
- `.b-papirfly__item.col-lg-3.col-6:nth-child(13) > .f-product-card[aria-role="button"][data-toggle="modal"]`
- `.b-papirfly__item.col-lg-3.col-6:nth-child(14) > .f-product-card[aria-role="button"][data-toggle="modal"]`
- `.b-papirfly__item.col-lg-3.col-6:nth-child(15) > .f-product-card[aria-role="button"][data-toggle="modal"]`
- `.b-papirfly__item.col-lg-3.col-6:nth-child(16) > .f-product-card[aria-role="button"][data-toggle="modal"]`
- `.b-papirfly__item.col-lg-3.col-6:nth-child(17) > .f-product-card[aria-role="button"][data-toggle="modal"]`
