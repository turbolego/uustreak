...
**Timestamp:** 2026-03-30T03:26:54.131Z
...
- `.large-4.cpt.medium-6:nth-child(2) > .hovedscenen.alignment-top.bg-none > .les-mer-link`
- `.forestillinger-blocks-panel:nth-child(8) > .grid-container > .grid-padding-x.grid-x > .large-4.cpt.medium-6:nth-child(1) > .centralteatret.alignment-top.bg-none > .les-mer-link`
- `.large-4.cpt.medium-6:nth-child(3) > .centralteatret.alignment-top.bg-none > .les-mer-link`
- `.forestillinger-blocks-panel:nth-child(10) > .grid-container > .grid-padding-x.grid-x > .large-4.cpt.medium-6 > .centralteatret.alignment-top.bg-none > .les-mer-link`
- `.scroll-to-top`
