...
**Timestamp:** 2026-02-21T00:45:36.202Z
...
- `#portalframe1, .single-5 > .item-container > .list-item.line:nth-child(1) > .list-item-date > .list-item-time > .ical`
- `#portalframe1, .single-5 > .item-container > .list-item.line:nth-child(2) > .list-item-date > .list-item-time > .ical`
...
- `#portalframe1, .single-5 > .item-container > .list-item.line:nth-child(1) > .list-item-date`
- `#portalframe1, .list-item-link[data-itemid="34931"][data-itemdate="27.02.2026"] > .ul-main`
- `#portalframe1, .single-5 > .item-container > .list-item.line:nth-child(2) > .list-item-date`
