...
**Timestamp:** 2026-07-27T01:11:51.677Z
...
- `#portalframe1, .single-0.day-listings.single-date-list:nth-child(7) > .item-container > .list-item.line > .list-item-date > .list-item-time > .ical`
- `#portalframe1, .single-1.day-listings.single-date-list:nth-child(8) > .item-container > .list-item.line > .list-item-date > .list-item-time > .ical`
...
- `#portalframe1, a[data-itemdate="27.07.2026"] > .ul-main`
...
- `#portalframe1, .single-0.day-listings.single-date-list:nth-child(7) > h1`
- `#portalframe1, .single-0.day-listings.single-date-list:nth-child(7) > .item-container > .list-item.line > .imgContainer`
- `#portalframe1, .single-0.day-listings.single-date-list:nth-child(7) > .item-container > .list-item.line > .list-item-date`
- `#portalframe1, a[data-itemdate="01.08.2026"] > .ul-main`
- `#portalframe1, .single-1.day-listings.single-date-list:nth-child(8) > h1`
- `#portalframe1, .single-1.day-listings.single-date-list:nth-child(8) > .item-container > .list-item.line > .imgContainer`
- `#portalframe1, .single-1.day-listings.single-date-list:nth-child(8) > .item-container > .list-item.line > .list-item-date`
