...
**Timestamp:** 2026-01-07T01:20:47.367Z
...
- `div[data-blockid="1301"] > .ssp__panel__news-item:nth-child(2) > .ssp__panel__news-item-anchor > .ssp__panel__news-image-text > .row > .col-sm-5.pr-15.pr-sm-0 > .ssp__panel__news-image[data-responsiveimage="true"][width="204"]`
- `.ssp__footer-wave`
...
- `#portalframe1, a[data-itemdate="08.01.2026"] > .ul-main`
- `#portalframe1, .single-1 > h1`
- `#portalframe1, .single-1 > .item-container > .list-item.line > .list-item-date`
- `#portalframe1, a[data-itemid="37809"] > .ul-main`
- `#portalframe1, .single-2 > h1`
- `#portalframe1, .single-2 > .item-container > .list-item.line:nth-child(1) > .list-item-date`
- `#portalframe1, .list-item-link[data-itemid="32260"][data-itemdate="13.01.2026"] > .ul-main`
- `#portalframe1, .list-item.line:nth-child(2) > .list-item-date`
- `#portalframe1, a[data-itemid="37856"] > .ul-main`
- `#portalframe1, .list-item.line:nth-child(3) > .list-item-date`
- `#portalframe1, a[data-itemid="37815"] > .ul-main`
- `.mt-20`
