...
**Timestamp:** 2026-02-03T00:42:08.069Z
...
- `.liveticker-red`
- `a[aria-label="– Truet med kniv i sentrum"] > .article__text-container > .article__section`
...
- `article[data-pulse-entity-id="rrW9nm"] > .article__teaser-container > .article__link.url > .article__text-container > .article__section-kicker-container > .article__section`
- `.opinion-banner-desc`
- `a[aria-label="– Totalt useriøst"] > .article__text-container > .article__section-kicker-container > .article__section`
- `#Vågen`
- `#Finse`
- `#Danmarks\ plass`
- `#Torgallmeningen`
...
- `.collage-x4`
- `article[data-pulse-entity-id="43z8ja"] > .display-flex.article__teaser-container > .article__text-container`
...
- `.item:nth-child(3)`
- `article[data-pulse-entity-id="3p6g4X"] > .display-flex.article__teaser-container > .article__text-container`
...
- `.row--full.horizontal-x1.row:nth-child(54)`
