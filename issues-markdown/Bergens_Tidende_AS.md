...
**Timestamp:** 2026-05-11T00:59:44.692Z
...
- `a[aria-label="PC begynte å brenne"] > .article__text-container > .article__section`
- `.timeline--item:nth-child(1) > a > .timeline--date`
- `.timeline--item:nth-child(2) > a > .timeline--date`
- `.timeline--item:nth-child(3) > a > .timeline--date`
...
- `article[data-pulse-entity-id="LnJM5J"] > .article__teaser-container > .article__link.url > .article__text-container > .article__section`
- `#Vågen`
- `#Finse`
- `#Danmarks\ plass`
- `#Torgallmeningen`
...
- `#dr-edition-teaser-kuh6340k > div`
- `._sr-only_gcann_153`
