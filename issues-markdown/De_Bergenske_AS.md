...
**Timestamp:** 2026-01-26T00:41:25.789Z
...
- `.grid-of-1.space-y-6.lg\:space-y-0 > .lg\:col-span-3.collection-item--fullWidth[theme=""] > .sm\:ml-6.-mt-9.bg-secondary > h2`
...
- `.lg\:flex-col-reverse.lg\:h-\[740px\][theme="DARK"]:nth-child(1) > .h-auto.max-w-full.sm\:px-6`
- `.lg\:h-\[740px\].collection-item[theme="DARK"]:nth-child(2) > .h-auto.max-w-full.sm\:px-6`
- `.lg\:flex-col-reverse.lg\:h-\[740px\][theme="DARK"]:nth-child(3) > .h-auto.max-w-full.sm\:px-6`
- `.DARK.\!bg-Theme\/Dark:nth-child(3) > .py-15[data-v-45215bba=""] > .container[data-v-45215bba=""] > .grid-of-1.space-y-6.lg\:space-y-0 > .lg\:col-span-3.collection-item--fullWidth[theme=""] > .flex-1.media.stretch`
- `.splide__arrow--prev.left-5[aria-controls="splide01-track"] > .w-12`
- `.splide__arrow--next.right-5[aria-controls="splide01-track"] > .w-12`
- `.grid-of-1.space-y-6.lg\:space-y-0 > .lg\:col-span-3.collection-item--fullWidth[theme=""] > .sm\:pr-6.flex-1.media`
...
- `.grid-of-6 > .lg\:col-span-2.col-span-1[theme=""]:nth-child(1) > .sm\:ml-6.-mt-9.bg-secondary > .items-end.gap-x-6.flex > .shrink-0.text-4xl.hover\:border-brand`
- `.grid-of-6 > .lg\:row-span-2.lg\:col-start-3[theme=""] > .sm\:ml-6.-mt-9.bg-secondary > .items-end.gap-x-6.flex > .shrink-0.text-4xl.hover\:border-brand`
- `.grid-of-6 > .lg\:row-start-2.col-span-1[theme=""]:nth-child(3) > .sm\:ml-6.-mt-9.bg-secondary > .items-end.gap-x-6.flex > .shrink-0.text-4xl.hover\:border-brand`
- `.grid-of-6 > .lg\:row-start-2.col-span-1[theme=""]:nth-child(4) > .sm\:ml-6.-mt-9.bg-secondary > .items-end.gap-x-6.flex > .shrink-0.text-4xl.hover\:border-brand`
- `.grid-of-6 > .lg\:row-start-3.col-span-1[theme=""]:nth-child(5) > .sm\:ml-6.-mt-9.bg-secondary > .items-end.gap-x-6.flex > .shrink-0.text-4xl.hover\:border-brand`
- `.lg\:col-span-2.lg\:row-start-3[theme=""] > .sm\:ml-6.-mt-9.bg-secondary > .items-end.gap-x-6.flex > .shrink-0.text-4xl.hover\:border-brand`
- `.grid-of-5 > .lg\:col-span-2.col-span-1[theme=""] > .sm\:ml-6.-mt-9.bg-secondary > .items-end.gap-x-6.flex > .shrink-0.text-4xl.hover\:border-brand`
- `.grid-of-5 > .lg\:row-span-2.lg\:col-start-3[theme=""] > .sm\:ml-6.-mt-9.bg-secondary > .items-end.gap-x-6.flex > .shrink-0.text-4xl.hover\:border-brand`
- `.grid-of-5 > .lg\:row-start-2.col-span-1[theme=""]:nth-child(3) > .sm\:ml-6.-mt-9.bg-secondary > .items-end.gap-x-6.flex > .shrink-0.text-4xl.hover\:border-brand`
- `.grid-of-5 > .lg\:row-start-2.col-span-1[theme=""]:nth-child(4) > .sm\:ml-6.-mt-9.bg-secondary > .items-end.gap-x-6.flex > .shrink-0.text-4xl.hover\:border-brand`
...
- `.grid-of-6 > .lg\:col-span-2.col-span-1[theme=""]:nth-child(1) > .sm\:pr-6.flex-1.media`
- `.lg\:col-span-2.col-span-1[theme=""]:nth-child(1) > .sm\:ml-6.-mt-9.bg-secondary > h3`
- `.grid-of-6 > .lg\:col-span-2.col-span-1[theme=""]:nth-child(1) > .sm\:ml-6.-mt-9.bg-secondary > .items-end.gap-x-6.flex > .grow.\!text-textcolor.font-light`
- `.grid-of-6 > .lg\:row-span-2.lg\:col-start-3[theme=""] > .sm\:pr-6.flex-1.media`
- `.lg\:row-span-2.lg\:col-start-3[theme=""] > .sm\:ml-6.-mt-9.bg-secondary > h3`
- `.grid-of-6 > .lg\:row-span-2.lg\:col-start-3[theme=""] > .sm\:ml-6.-mt-9.bg-secondary > .items-end.gap-x-6.flex > .grow.\!text-textcolor.font-light`
- `.grid-of-6 > .lg\:row-start-2.col-span-1[theme=""]:nth-child(3) > .sm\:pr-6.flex-1.media`
- `.lg\:row-start-2.col-span-1[theme=""]:nth-child(3) > .sm\:ml-6.-mt-9.bg-secondary > h3`
- `.grid-of-6 > .lg\:row-start-2.col-span-1[theme=""]:nth-child(3) > .sm\:ml-6.-mt-9.bg-secondary > .items-end.gap-x-6.flex > .grow.\!text-textcolor.font-light`
- `.grid-of-6 > .lg\:row-start-2.col-span-1[theme=""]:nth-child(4) > .sm\:pr-6.flex-1.media`
- `.lg\:row-start-2.col-span-1[theme=""]:nth-child(4) > .sm\:ml-6.-mt-9.bg-secondary > h3`
- `.grid-of-6 > .lg\:row-start-2.col-span-1[theme=""]:nth-child(4) > .sm\:ml-6.-mt-9.bg-secondary > .items-end.gap-x-6.flex > .grow.\!text-textcolor.font-light`
- `.grid-of-6 > .lg\:row-start-3.col-span-1[theme=""]:nth-child(5) > .sm\:pr-6.flex-1.media`
- `.lg\:row-start-3.col-span-1[theme=""]:nth-child(5) > .sm\:ml-6.-mt-9.bg-secondary > h3`
- `.grid-of-6 > .lg\:row-start-3.col-span-1[theme=""]:nth-child(5) > .sm\:ml-6.-mt-9.bg-secondary > .items-end.gap-x-6.flex > .grow.\!text-textcolor.font-light`
- `.lg\:col-span-2.lg\:row-start-3[theme=""] > .sm\:pr-6.flex-1.media`
- `.lg\:col-span-2.lg\:row-start-3[theme=""] > .sm\:ml-6.-mt-9.bg-secondary > h3`
- `.lg\:col-span-2.lg\:row-start-3[theme=""] > .sm\:ml-6.-mt-9.bg-secondary > .items-end.gap-x-6.flex > .grow.\!text-textcolor.font-light`
- `.grid-of-5 > .lg\:col-span-2.col-span-1[theme=""] > .sm\:pr-6.flex-1.media`
- `.lg\:col-span-2.col-span-1[theme=""] > .sm\:ml-6.-mt-9.bg-secondary > h2`
- `.grid-of-5 > .lg\:col-span-2.col-span-1[theme=""] > .sm\:ml-6.-mt-9.bg-secondary > .items-end.gap-x-6.flex > .grow.\!text-textcolor.font-light`
- `.grid-of-5 > .lg\:row-span-2.lg\:col-start-3[theme=""] > .sm\:pr-6.flex-1.media`
- `.lg\:row-span-2.lg\:col-start-3[theme=""] > .sm\:ml-6.-mt-9.bg-secondary > h2`
- `.grid-of-5 > .lg\:row-span-2.lg\:col-start-3[theme=""] > .sm\:ml-6.-mt-9.bg-secondary > .items-end.gap-x-6.flex > .grow.\!text-textcolor.font-light`
- `.grid-of-5 > .lg\:row-start-2.col-span-1[theme=""]:nth-child(3) > .sm\:pr-6.flex-1.media`
- `.lg\:row-start-2.col-span-1[theme=""]:nth-child(3) > .sm\:ml-6.-mt-9.bg-secondary > h2`
- `.grid-of-5 > .lg\:row-start-2.col-span-1[theme=""]:nth-child(3) > .sm\:ml-6.-mt-9.bg-secondary > .items-end.gap-x-6.flex > .grow.\!text-textcolor.font-light`
- `.grid-of-5 > .lg\:row-start-2.col-span-1[theme=""]:nth-child(4) > .sm\:pr-6.flex-1.media`
- `.lg\:row-start-2.col-span-1[theme=""]:nth-child(4) > .sm\:ml-6.-mt-9.bg-secondary > h2`
- `.grid-of-5 > .lg\:row-start-2.col-span-1[theme=""]:nth-child(4) > .sm\:ml-6.-mt-9.bg-secondary > .items-end.gap-x-6.flex > .grow.\!text-textcolor.font-light`
- `.lg\:col-span-3.lg\:row-start-3[theme=""] > .sm\:pr-6.flex-1.media`
