...
**Timestamp:** 2025-10-13T00:25:44.232Z
...
- `button[aria-controls="modal-567170"]`
...
- `#react_0HNG49MV8NVHM > .my-10 > .md\:grid-cols-4.mb-16.gap-7 > .group.relative:nth-child(2) > div > .md\:flex-col.space-x-4.md\:space-x-0 > .w-2\/5.md\:mb-3.md\:w-full > .overflow-hidden.rounded-lg > picture > .t-\[10px\].md\:rounded-\[10px\].md\:group-hover\:scale-110`
